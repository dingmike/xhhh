...
<template>
  <div class="upload-container">
    <uploadImg class="image-uploader"
      ...
      <div slot="tip" class="el-upload__tip">添加图片(最多1张)</div>
    ...
    <el-dialog width="60%" v-el-drag-dialog :visible.sync="dialogCorpperBox">
      ...
      <div class="test-button">
        &lt;!&ndash;<button @click="changeImg" class="btn">changeImg</button>&ndash;&gt;
        <label class="btn" for="uploads">选择一张图片</label>
        <input type="file" id="uploads" style="position:absolute; clip:rect(0 0 0 0);"
               accept="image/png, image/jpeg, image/gif, image/jpg" @change="uploadImg($event, 1)">
        &lt;!&ndash;<button @click="startCrop" v-if="!crap" class="btn">start</button>&ndash;&gt;
        &lt;!&ndash;<button @click="stopCrop" v-else class="btn">stop</button>&ndash;&gt;
        &lt;!&ndash;<button @click="clearCrop" class="btn">clear</button>&ndash;&gt;
        &lt;!&ndash;<button @click="refreshCrop" class="btn">refresh</button>&ndash;&gt;
        ...
        &lt;!&ndash;<button @click="finish('blob')" class="btn">preview(blob)</button>&ndash;&gt;
        <a @click="down('base64')" class="btn">下载</a>
        &lt;!&ndash;<a @click="down('blob')" class="btn">download(blob)</a>&ndash;&gt;
